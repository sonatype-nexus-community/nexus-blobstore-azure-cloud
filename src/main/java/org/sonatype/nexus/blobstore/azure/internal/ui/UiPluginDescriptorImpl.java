...
/**
 * Rapture {@link UiPluginDescriptor} for {@code nexus-blobstore-azure-cloud}.
 *
 */
@Named
@Singleton
    ...
    extends UiPluginDescriptorSupport
{
  ...
  public UiPluginDescriptorImpl() {
    super("nexus-blobstore-azure-cloud");
    setHasStyle(false);
    setNamespace("NX.azureblobstore");
    setConfigClassName("NX.azureblobstore.app.PluginConfig");
  }
}
